...
import com.parameta.util.Validaciones;
...
public class EmpleadoController {
	...
	public ResponseEntity<Empleado> getEmpleadosById(@PathVariable(value = "id") Long userId) throws Exception {
	...
	public ResponseEntity<Empleado> updateEmpelado(@PathVariable(value = "id") Long empleadoId,
			@Valid @RequestBody Empleado empleadoDetails) throws Exception {
